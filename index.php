                                    ...
                                    <div class="testimonial-one owl-carousel">
                                        ...
                                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                            ...
                                            if ($best_meal_plan) {
                                                ...
                                                echo "<p>Porsiyon/Adet/Kaşık: " . round($best_meal_plan['Breakfast Portion'] * 2) / 2 . "</p>";
                                                echo "<p>Kalori: $breakfast_calories</p>";
                                                echo "<p>Karbonhidrat: $breakfast_carbohydrate g</p>";
                                                echo "<p>Protein: $breakfast_protein g</p>";
                                                echo "<p>Yağ: $breakfast_fat g</p>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                                ...
                                                echo "<p>Porsiyon/Adet/Kaşık: " . round($best_meal_plan['Lunch/Snacks Portion'] * 2) / 2 . "</p>";
                                                echo "<p>Kalori: $lunch_calories</p>";
                                                echo "<p>Karbonhidrat: $lunch_carbohydrate g</p>";
                                                echo "<p>Protein: $lunch_protein g</p>";
                                                echo "<p>Yağ: $lunch_fat g</p>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                                ...
                                                echo "<p>Porsiyon/Adet/Kaşık: " . round($best_meal_plan['One Dish Meal Portion'] * 2) / 2 . "</p>";
                                                echo "<p>Kalori: $dinner_calories</p>";
                                                echo "<p>Karbonhidrat: $dinner_carbohydrate g</p>";
                                                echo "<p>Protein: $dinner_protein g</p>";
                                                echo "<p>Yağ: $dinner_fat g</p>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                                ...
                                                echo "<h3>Toplam Değerler</h3>";
                                                echo "<p>Toplam Kalori: $total_calories</p>";
                                                echo "<p>Toplam Karbonhidrat: $total_carbohydrate g</p>";
                                                echo "<p>Toplam Protein: $total_protein g</p>";
                                                echo "<p>Toplam Yağ: $total_fat g</p>";
                                                echo "</div>";
                                            }
                                            else {
                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <p class="fs-14 mb-2">Toplam Kalori</p>
                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <p class="fs-14 mb-2">Toplam Karbonhidrat</p>
                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <p class="fs-14 mb-2">Toplam Protein</p>
                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <p class="fs-14 mb-2">Toplam Yağ</p>
                        ...
                        <div class="col-xl-12">
                            <div class="card featuredMenu">
                                <div class="card-header border-0">
                                    <h4 class="text-black font-w600 fs-20 mb-0">History</h4>
                                </div>
